...
export const Route = createFileRoute("/sunrise-sunset")({
  head: () => {
    const seo = subPageSeo("/sunrise-sunset", "Sunrise & Sunset Times", DESCRIPTION, "WebPage");
    return {
      meta: [
        ...seo.meta,
        { title: TITLE },
  ...
  return (
    <SiteLayout>
      ...
      <div className="mt-14 space-y-16">
        <PageSection
          id="today"
          title="Today's daylight"
          description="Sunrise, sunset and daylight length for major cities."
        >
        ...
        <PageSection
          id="more"
          title="More cities"
          description="Daylight for additional locations across other regions."
        >
