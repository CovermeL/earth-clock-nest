...
export const Route = createFileRoute("/daylight-saving")({
  head: () => {
    const seo = subPageSeo("/daylight-saving", "Daylight Saving Time", DESCRIPTION, "Article");
    return {
      meta: [
        ...seo.meta,
        { title: TITLE },
  ...
  return (
    <SiteLayout>
      ...
      <div className="mt-14 space-y-16">
        <PageSection
          id="status"
          title="Who is on summer time right now"
          description="Live daylight saving status for major regions, checked against the IANA time zone database."
        >
          <DstPanel />
        </PageSection>
        ...
        <PageSection
          id="affected"
          title="Cities affected today"
          description="Current local times where a daylight saving offset may apply."
        >
